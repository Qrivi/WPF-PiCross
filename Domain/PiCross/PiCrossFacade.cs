...
namespace PiCross
{
    ...
    public class PiCrossFacade
    {
        ...
        {
            var data = new InMemoryDatabase(InMemoryDatabase.PuzzleLibrary.CreateEmpty(),
                InMemoryDatabase.PlayerDatabase.CreateEmpty());
        ...
        /// </summary>
        /// <param name="puzzle">
        ///     Puzzle to be edited. Note that this object cannot be changed; the editor
        ///     uses this puzzle solely as an initial state.
        /// </param>
        ...
        public IStepwisePuzzleSolver CreateStepwisePuzzleSolver(ISequence<Constraints> rowConstraints,
        ...
        {
            return new PlayablePuzzle(puzzle.ColumnConstraints, puzzle.RowConstraints);
        }

        public IPlayablePuzzle CreateExtendedPlayablePuzzle(Puzzle puzzle)
        {
            return new ExtendedPlayablePuzzle(puzzle.ColumnConstraints, puzzle.RowConstraints);
        }
    }
}